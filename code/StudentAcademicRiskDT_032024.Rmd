...
model_features = ['GPA_MOD', 'HSCH_GPA', 'PCOL_GPA', 'UMF_OVERALL_GPA',
                  ...
                  'FIRST_GEN_BIN', 'ADV_VISIT_COUNT','AnalysisCode_cat']
...
model = DecisionTreeClassifier(max_leaf_nodes=15)  # Limit the number of leaf nodes
